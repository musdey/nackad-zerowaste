...
import localPickup from './newOrder-localPickup'
import newOrder from './newOrder-webhook'
...
beforeAll(async () => {
  ...
  new Product({
    deposit: 'Midiglas-100',
    shopifyId: '7553231028471'
  }).save()
})
...
describe('Test local pickup: Creating order and deposit items', () => {
  it('cheks whether first order is successfully stored', async () => {
